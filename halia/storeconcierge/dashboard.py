...
<link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 40 40' fill='none' stroke='%235C3B54' stroke-width='1.8' stroke-linecap='round' stroke-linejoin='round'><circle cx='20' cy='6.4' r='2' fill='%235C3B54' stroke='none'/><path d='M20 8.3V11'/><path d='M9.5 25.5C9.5 15 13 11.2 20 11.2S30.5 15 30.5 25.5'/><path d='M8 25.7Q20 28.6 32 25.7'/><path d='M7 28.6H33'/><path d='M10.5 31.2H29.5'/><path d='M12 31.2v1.8M28 31.2v1.8'/><path d='M5.6 15.8Q2.9 18.6 4.5 21.8'/><path d='M34.4 15.8Q37.1 18.6 35.5 21.8'/></svg>">
<style>
...
<header><div class="wrap bar">
  <a class="logo" href="/storeconcierge"><svg class="bell" viewBox="0 0 40 40" width="23" height="23" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="20" cy="6.4" r="1.9" fill="currentColor" stroke="none"/><path d="M20 8.3V11"/><path d="M9.5 25.5C9.5 15 13 11.2 20 11.2S30.5 15 30.5 25.5"/><path d="M8 25.7Q20 28.6 32 25.7"/><path d="M7 28.6H33"/><path d="M10.5 31.2H29.5"/><path d="M12 31.2v1.8M28 31.2v1.8"/><path d="M5.6 15.8Q2.9 18.6 4.5 21.8"/><path d="M34.4 15.8Q37.1 18.6 35.5 21.8"/></svg> Store Concierge</a>
