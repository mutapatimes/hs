...
INDUSTRIES = [
    {
        ...
        "h1": "The first modest order that hides your next house client.",
    ...
    },
    {
        ...
        "h1": "The quiet regular who turns out to be a serious collector.",
    ...
    },
    {
        ...
        "h1": "A £30 lipstick looks the same whoever buys it.",
    ...
    },
    {
        ...
        "h1": "A £120 strap buyer hiding a £50,000 collector.",
    ...
    },
    {
        ...
        "h1": "The cushion buyer hiding a whole-house project.",
    ...
    },
    {
        ...
        "h1": "The standing weekly order that hides a house account.",
    ...
    },
    {
        ...
        "h1": "£20 paperbacks and £8,000 first editions, one till.",
    ...
    },
    {
        ...
        "h1": "In a book this big, the high-value buyer is invisible.",
...
FLOW = {
    ...
    "beauty": {
        ...
        "actions": ["Tagged &middot; High ceiling", "Suggested for outreach", "Templates ready"],
        "emails": [
...
PRODUCT = {
    ...
    "beauty": "A signature eau de parfum &middot; &pound;34",
    "jewellery": "A leather watch strap &middot; &pound;140",
    "home": "A pair of linen cushions &middot; &pound;75",
    "gifting": "A weekly hand-tied bouquet &middot; &pound;48",
...
_CSS = """
  ...
  *{box-sizing:border-box}html{scroll-behavior:smooth}
  ...
  .eyebrow{font:500 12px/1 var(--sans);color:var(--accent)}
  h1,h2,h3{font-family:var(--serif);font-weight:400;letter-spacing:-.01em;margin:0;line-height:1.05}
  ...
  .burger{display:none;align-items:center;justify-content:center;width:42px;height:42px;border-radius:0;border:1px solid var(--line);background:transparent;color:var(--ink);cursor:pointer;flex:none;padding:0}
  ...
  .mdrawer a.mcta{margin-top:20px;border:none;background:var(--ink);color:var(--bg);text-align:center;border-radius:0;padding:15px;font-weight:600}
  ...
  .sec .k{font:600 13px var(--sans);color:var(--mute);margin-bottom:12px}
  ...
  .pc .l{font:500 11px var(--sans);color:var(--faint);margin-bottom:8px}.pc .hi .l{color:rgba(246,246,244,.6)}
  ...
  .exc{border:1px solid var(--line);border-radius:0;padding:26px 28px;background:var(--bg-2)}
  ...
  .exrow .m .l{font:500 11px var(--sans);color:var(--faint);margin-bottom:2px}
  .exrow .m .v{font-family:var(--serif);font-size:21px}
  .exrow .m .v .g{display:inline-block;background:var(--ink);color:var(--bg);border-radius:0;padding:2px 11px;font:600 13px var(--sans)}
  ...
  .ltv .l{font:500 11px var(--sans);color:var(--faint);margin-bottom:12px}
  ...
  .tbl-wrap{overflow-x:auto;border:1px solid var(--line);border-radius:0;margin-top:30px}
  table.lt{width:100%;border-collapse:collapse;font-size:14px;min-width:600px}
  table.lt th{text-align:left;padding:12px 16px;background:var(--bg-2);color:var(--faint);font:600 10.5px var(--sans);white-space:nowrap}
  ...
  .surfaces .sl{font:500 11px var(--sans);color:var(--faint);margin:6px 0 14px}
  ...
  .others .sl{font:500 11px var(--sans);color:var(--faint);margin-bottom:14px}
  .others .row{display:flex;flex-wrap:wrap;gap:10px}
  .others a{font:500 13.5px var(--sans);color:var(--mute);border:1px solid var(--line);padding:9px 15px;border-radius:0}.others a:hover{border-color:var(--ink);color:var(--ink)}
  ...
  figure.shot img{width:100%;aspect-ratio:4/5;object-fit:cover;border-radius:0;display:block;background:var(--bg-2)}
  ...
  .twhen{font:500 11px var(--sans);color:var(--faint);margin-bottom:11px}
  ...
  .roi .roi-lead{font:600 10.5px var(--sans);color:var(--accent);margin-bottom:10px}
  .roi .roi-big{font-family:var(--serif);font-size:clamp(34px,5vw,48px);line-height:1;color:var(--ink)}
  .roi .roi-big span{display:block;font-family:var(--sans);font-weight:500;font-size:11px;color:var(--faint);margin-top:8px}
  ...
  .mtr .ml{font:500 9.5px var(--sans);color:var(--faint);margin-top:5px;display:block}
  ...
  .cmp-h{font:600 11px var(--sans);color:var(--faint);margin-bottom:13px}
...
_ASTER = '<svg viewBox="0 0 100 100" width="1em" height="1em" aria-hidden="true" style="vertical-align:-.12em"><path fill="currentColor" d="M52.33,23.44 53.41,7.94 46.59,7.94 47.67,23.44ZM50.72,25.65 65.80,21.90 63.69,15.41 49.28,21.23ZM48.12,24.81 56.35,37.99 61.87,33.98 51.88,22.08ZM48.12,22.08 38.13,33.98 43.65,37.99 51.88,24.81ZM50.72,21.23 36.31,15.41 34.20,21.90 49.28,25.65ZM29.33,63.28 30.41,47.78 23.59,47.78 24.68,63.28ZM27.72,65.49 42.80,61.73 40.69,55.25 26.28,61.07ZM25.12,64.65 33.35,77.82 38.87,73.81 28.88,61.91ZM25.12,61.91 15.13,73.81 20.65,77.82 28.88,64.65ZM27.72,61.07 13.31,55.25 11.20,61.73 26.28,65.49ZM75.33,63.28 76.41,47.78 69.59,47.78 70.67,63.28ZM73.72,65.49 88.80,61.73 86.69,55.25 72.28,61.07ZM71.12,64.65 79.35,77.82 84.87,73.81 74.88,61.91ZM71.12,61.91 61.13,73.81 66.65,77.82 74.88,64.65ZM73.72,61.07 59.31,55.25 57.20,61.73 72.28,65.49Z"/></svg>'
...
def _nav() -> str:
    return (
        ...
        '<a href="/pricing">Pricing</a><a href="/blog">Blog</a></nav>'
...
def _footer() -> str:
    return (
        ...
        '<div class="hf-news"><h3>The edge in luxury retail, in your inbox.</h3>'
        ...
        '<div class="hf-brand">'
        f'<a class="brand" href="/"><span aria-hidden="true" style="font-family:\'Cormorant Garamond\',Georgia,serif;font-size:22px;line-height:1;color:var(--accent,#5E6B74)">{_ASTER}</span>Halia</a>'
        '<p class="hf-bio">Halia is private client intelligence for luxury retail. It reads the '
        'signs of wealth in your own order data, grades every customer A&#42; to C, and surfaces the '
        'high-value clients hiding behind modest spend. Then it hands your team the tools to act, '
        'and to measure what the relationships return.</p>'
        '<a class="hf-social" href="https://www.linkedin.com/company/haliascore" target="_blank" '
        'rel="noopener" aria-label="Halia on LinkedIn">'
        '<svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">'
        '<path d="M4.98 3.5a2.5 2.5 0 110 5 2.5 2.5 0 010-5zM3 9h4v12H3zM9 9h3.8v1.7h.05c.53-1 '
        '1.83-2.05 3.76-2.05 4.02 0 4.76 2.65 4.76 6.1V21h-4v-5.3c0-1.26-.02-2.9-1.77-2.9-1.77 '
        '0-2.04 1.38-2.04 2.8V21H9z"/></svg><span>Follow on LinkedIn</span></a></div>'
        '<div class="hf-cols">'
        '<div class="hf-col"><h4>Product</h4><a href="/#engine">The engine</a><a href="/#how">How it works</a>'
        '<a href="/#signals">Signals</a><a href="/#teams">For teams</a><a href="/connect">Connect a store</a><a href="/docs">Docs</a></div>'
        ...
        '<div class="hf-col"><h4>Company</h4><a href="/clienteling">Clienteling</a><a href="/pricing">Pricing</a><a href="/roi">ROI calculator</a>'
        ...
        '</div>'
        '<div class="hf-bot"><span>&copy; 2026 Halia. All rights reserved.</span></div>'
        '</div></footer>'
    )
