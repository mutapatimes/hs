...
def _footer() -> str:
    return (
        ...
        'data is released the moment the work is done. Zero retention, by architecture.</p>'
        ...
        '<a href="/pricing">Pricing</a><a href="/blog">Blog</a><a href="/security">Security</a><a href="/faq">FAQ</a>'
