...
BRANDS = [
    ...
    # --- added from Mytheresa + SSENSE: buzzy emerging / avant modern-feminine ---
    ("Coperni", "contemporary", "indie", "buzzy modern, viral moments, Paris"),
    ("Nensi Dojaka", "contemporary", "indie", "LVMH-prize; sheer modern, London"),
    ("Rohe", "minimal", "indie", "Irish modern minimal (Rohe Studios)"),
    ("Rotate", "contemporary", "indie", "Birger Christensen; contemporary DTC, big IG"),
    ("Nanushka", "contemporary", "indie", "Budapest, vegan-leather modern, DTC"),
    ("The Attico", "contemporary", "indie", "Italian, buzzy modern-glam"),
    ("Veronica Beard", "contemporary", "indie", "US contemporary, DTC-strong"),
    ("Aya Muse", "contemporary", "indie", "sculptural modern, buzzy"),
    ("Aeron", "minimal", "indie", "considered modern, Budapest"),
    ("David Koma", "occasion", "indie", "sculptural occasion, London"),
    ("Dorothee Schumacher", "contemporary", "indie", "German contemporary, founder-led"),
    ("Plan C", "contemporary", "indie", "Marni-family, creative modern"),
    ("16Arlington", "occasion", "indie", "London glamour, buzzy"),
    ("KNWLS", "contemporary", "indie", "London cult, sculpted modern"),
    ("Chopova Lowena", "contemporary", "indie", "London cult, craft-modern"),
    ("Sandy Liang", "contemporary", "indie", "NY cult, girlhood-modern, huge IG"),
    ("Ottolinger", "avant", "indie", "Berlin/Zurich avant, buzzy"),
    ("Molly Goddard", "romantic", "indie", "London tulle-romantic, cult"),
    ("Conner Ives", "contemporary", "indie", "London, upcycle-modern, buzzy"),
    ("Paloma Wool", "contemporary", "indie", "Spanish cult, art-led, DTC"),
    ("Interior", "minimal", "indie", "NY modern minimal, founder-led"),
    ("Meryll Rogge", "contemporary", "indie", "Belgian, ANDAM-recognised modern"),
    ("Marine Serre", "avant", "indie", "moon-print avant, sustainability"),
    ("House of Dagmar", "minimal", "indie", "Stockholm modern minimal"),
    ("Baserange", "minimal", "indie", "considered basics, sustainable"),
    ("Cordera", "minimal", "indie", "Spanish natural-fibre minimal"),
    ("Rosetta Getty", "minimal", "indie", "LA modern minimal, founder-led"),
    ("Wynn Hamlyn", "contemporary", "indie", "NZ modern, founder-led"),
    ("Paris Georgia", "contemporary", "indie", "NZ modern, founder-led"),
    ("Esse Studios", "minimal", "indie", "Australian modern minimal"),
    ("Filippa K", "minimal", "large", "Scandi minimal, larger"),
    ("by Malene Birger", "contemporary", "large", "Scandi contemporary, larger"),
    ("Vince", "minimal", "large", "US contemporary basics, larger"),
]
