...
SIGNAL_WEIGHTS: dict[str, int] = {
    ...
    "can_income": 2,      # Canada high-income FSA (CRA): base; tier overrides (CAN_INCOME_AREA_WEIGHTS)
    "intl_postcode": 3,
    "hnw_area": 3,
...
# France home-value code-postal tiers (open DVF, €/m² medians). Same shape as the UK area signal.
FR_PROPERTY_AREA_WEIGHTS = {
    "ultra": 3,
    "prime": 2,
    "high": 1,
}

# UAE high-value community tiers (DLD open data, AED/sqm medians). Name-matched, country-gated.
AE_PROPERTY_AREA_WEIGHTS = {
    "ultra": 3,
    "prime": 2,
    "high": 1,
}

# Australia home-value postcode tiers (NSW Valuer General bulk sales, AUD house medians).
AU_PROPERTY_AREA_WEIGHTS = {
    "ultra": 3,
    "prime": 2,
    "high": 1,
}
...
# Canada FSA income tiers (CRA taxation statistics, average total income).
CAN_INCOME_AREA_WEIGHTS = {
    "ultra": 3,
    "prime": 2,
    "high": 1,
}
...
SIGNAL_GROUP: dict[str, str] = {
    ...
    "can_income": "geo",      # Canada income FSA, same geography family
    "prime_residence": "geo",
    "gcc_billing": "geo",
...
SIGNALS = [
    ...
    ("fr_property", "High-value home area", fr_property.flag_fr_property,
     fr_property.FLAG_COL, lambda r: r[fr_property.REASON_COL]),
    ("ae_property", "High-value home area", ae_property.flag_ae_property,
    ...
    ("can_income", "High-income area", can_income.flag_can_income,
     can_income.FLAG_COL, lambda r: r[can_income.REASON_COL]),
...
def score_customers(
    ...
    for keys in grouped.values():
        ...
        for key in keys:
            ...
            if key == "delivery_venue":
            ...
            elif key == "fr_property":
                type_spec = (fr_property.TIER_COL, FR_PROPERTY_AREA_WEIGHTS)
            elif key == "ae_property":
                ...
                type_spec = (can_income.TIER_COL, CAN_INCOME_AREA_WEIGHTS)
